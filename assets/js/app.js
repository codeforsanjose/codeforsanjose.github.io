...
//     description:
//       "Import building data to Open Street Map, an open source map that anyone can edit. There are many applications, such as emergency disaster response and mapping navigation",
//     lead: "Minh Nguyen",
//     status: "Active",
//     skills: [
//       "People who want to learn mapping",
//       "data entry",
//       "mappers",
...
//     description:
//       "Map of public art and murals in the south bay of Bay Area, California",
//     lead: "John Lau",
//     status: "Active",
//     skills: [
//       "Mappers",
...
//     title: "Census 2020",
//     description:
//       "Create an informational website for the City of San José to inform San José residents why the Census 2020 matters and encourage residents to participate in the Census.",
//     lead: "Anathea Lolen",
//     status: "Active",
//     skills: [
//       "Web accessibility",
...
//     description:
//       "Redesign probation department website to help inform youth and families about resources and improve user experience.",
//     lead: "Cesar Arellano",
//     status: "Active",
//     skills: [
...
//     description:
//       "Redesign website for nonprofit Razing the Bar. The project was completed by September 2019.",
//     lead: "Sunny Mui",
//     status: "Complete",
...
//     description:
//       "An interactive map highlighting development projects for a local non-profit, Catalyze SV.",
//     lead: "Lena Tran",
//     status: "Complete",
...
function menu_toggle() {
  ...
  if (isMenuOpen == false) {
    ...
    menuBtn.style.background = "#444444";
    faBtn.classList.remove("fa-bars");
  } else {
    isMenuOpen = false;
    navigation.style.left = "-100%";
    faBtn.classList.add("fa-bars");
    menuBtn.style.background = "#222222";
